...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let scrollToDiv;
  $$unsubscribe_page();
  return `${$page.data.user ? `<div class="${"flex flex-col pt-4 w-full px-8 items-center gap-2"}"><div><a href="${"/test"}" class="${"mt-[100px] p-3 flex justify-center items-center bg-black text-white"}">Take a test</a>
