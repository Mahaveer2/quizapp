<div class="container mt-14">
	...
	<p class="mt-2">
		...
		You must use your email to login. Best practices strongly encourage you to only use a
		randomly generated password and not to use the same password you employ for other university
		. Other than your account email, account password, usage and session history NO other
